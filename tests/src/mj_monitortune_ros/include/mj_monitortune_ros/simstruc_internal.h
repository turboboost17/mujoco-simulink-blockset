...
#ifdef SS_SL_INTERNAL
#pragma once
#endif
#ifndef SIMSTRUC_INTERNAL_H
#define SIMSTRUC_INTERNAL_H
...
#define _ssGetErrorStatus(S) \
    ((S)->root->mdlInfo->mdlFlags.errorStatusIsMsg == 1U ? SS_NULL : (S)->root->errorStatus.str)
...
#define _ssGet_slErrMsg(S) \
    ((S)->root->mdlInfo->mdlFlags.errorStatusIsMsg == 0U ? SS_NULL : (S)->root->errorStatus.msg)
...
#define ssGetIsVmSimulationCompile(S)       \
    ((((S)->mdlInfo->genericFcn == SS_NULL) \
          ? 0                               \
          : ((*(S)->mdlInfo->genericFcn)((S), GEN_FCN_VM_SIMULATION_COMPILE, 0, SS_NULL))) == 1)
/*
...
#define _ssSetInputPortNumDimensions(S, port, val)                                         \
    {                                                                                      \
        ...
        if (val == 1) {                                                                    \
            if ((S)->portInfo.inputs != SS_NULL) {                                         \
                (S)->portInfo.inputs[(port)].dims = &((S)->portInfo.inputs[(port)].width); \
            }                                                                              \
            if (ssGetBlkInfo2Ptr(S) != SS_NULL &&                                          \
                (S)->blkInfo.blkInfo2->blkInfoSLSize != SS_NULL) {                         \
...
#define ssAllowSignalsHandleBigLong(S)                                              \
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_SET_SIGS_ALLOW_BIG_LONG, 1, SS_NULL) \
        _ssSafelyCallGenericFcnEnd
#else
#define ssAllowSignalsHandleBigLong(S)
#endif
...
#define ssSetInputPortAccessedByAddress(S, portIdx)                                      \
    {                                                                                    \
        _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_SET_INPUT_PORT_ACCESSED_BY_ADDRESS, \
                                        (portIdx), SS_NULL) _ssSafelyCallGenericFcnEnd;  \
    }
#endif
...
#define _ssCacheSFcnParamValueAttribs(pName, dtId, nDims, dimsPtr, cplx) \
    ...
    locPI.data = SS_NULL;                                                \
    locPI.dataAttributes = SS_NULL;                                      \
    locPI.nDlgParamIndices = 0;                                          \
    locPI.dlgParamIndices = SS_NULL;                                     \
...
#define ssSetStateflowIsInlinable(S, p) \
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_SF_INLINABLE, p, SS_NULL) _ssSafelyCallGenericFcnEnd
#endif

#if SS_SFCN && SS_SIM
#define ssSetOutputFcnCalledMultiple(S, p)                                                 \
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_SET_OUTPUT_FCN_CALLED_MULTIPLE, p, SS_NULL) \
        _ssSafelyCallGenericFcnEnd
#endif

#if SS_SFCN && SS_SIM
#define ssSetNotMultipleInlinable(S, p)                                                 \
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_SET_NOT_MULTIPLE_INLINEABLE, p, SS_NULL) \
        _ssSafelyCallGenericFcnEnd
#endif
...
typedef struct _ssRTPFromDataInfoWithConv_tag {
    ...
    int* paramIndices;        /* dlg prms, could be SS_NULL     */
...
#define ssSetSFInitOutput(S, val)                                                    \
    _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_SET_SF_INIT_OUTPUT, (val), SS_NULL) \
        _ssSafelyCallGenericFcnEnd
...
#define ssSetRequiredStackSize(S, val)                                                    \
    _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_SET_REQUIRED_STACK_SIZE, (val), SS_NULL) \
        _ssSafelyCallGenericFcnEnd
#else
...
#define ssComputeOutput(S, pIdx)                                              \
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_COMPUTE_OUTPUT, pIdx, SS_NULL) \
        _ssSafelyCallGenericFcnEnd
#else
...
#define ssSetEnableFcnIsTrivial(S, trivial)                                                 \
    _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_ENABLE_FCN_IS_TRIVIAL, (trivial), SS_NULL) \
        _ssSafelyCallGenericFcnEnd
#else
...
#define ssSetDisableFcnIsTrivial(S, trivial)                                                 \
    _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_DISABLE_FCN_IS_TRIVIAL, (trivial), SS_NULL) \
        _ssSafelyCallGenericFcnEnd
#else
...
#define ssGetDWorkRequireResetForSignalSize(S, index) \
    SS_STATIC_CAST(SS_VariableSizeStateResetType,     \
                   (S)->work.dWorkAux[(index)].flags.ensureResetForSizeVary)
...
#define ssSetNumDataStores(S, numDataStores)                                               \
    _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_REGISTER_NUM_DATA_STORE, (numDataStores), \
                                    SS_NULL) _ssSafelyCallGenericFcnEnd
#endif
...
#define ssReadFromDataStore(S, dsmIdx, dataAddr) \
    ssReadFromDataStoreWithPath(S, dsmIdx, SS_NULL, dataAddr)
#endif
...
#define ssWriteToDataStore(S, dsmIdx, dataAddr) \
    ssWriteToDataStoreWithPath(S, dsmIdx, SS_NULL, dataAddr)
#endif
...
#define ssUpdateDataStoreLog(S, dsmIdx)                                                      \
    {                                                                                        \
        _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_DATA_STORE_LOG_UPDATE, dsmIdx, SS_NULL) \
            _ssSafelyCallGenericFcnEnd;                                                      \
    }
...
#define ssReadFromDataStoreElement(S, dsmIdx, dataAddr, dsmElem) \
    ssReadFromDataStoreElementWithPath(S, dsmIdx, SS_NULL, dataAddr, dsmElem)
#endif
...
#define ssWriteToDataStoreElement(S, dsmIdx, dataAddr, dsmElem) \
    ssWriteToDataStoreElementWithPath(S, dsmIdx, SS_NULL, dataAddr, dsmElem)
#endif
...
#define ssReadFromDataStoreRegion(S, dsmIdx, dataAddr, dsmRegionDescriptor) \
    ssReadFromDataStoreRegionWithPath(S, dsmIdx, SS_NULL, dataAddr, dsmRegionDescriptor)
#endif
...
#define ssWriteToDataStoreRegion(S, dsmIdx, dataAddr, dsmRegionDescriptor) \
    ssWriteToDataStoreRegionWithPath(S, dsmIdx, SS_NULL, dataAddr, dsmRegionDescriptor)
#endif
...
#define ssGetModelReferenceType(S, val)                                         \
    {                                                                           \
        *(val) = MDLREF_UNKNOWN;                                                \
        if (!((ssGetOwnerBlock(S) == SS_NULL) && ((S)->parent != SS_NULL))) {   \
...
/* Structure for referenced models info. mrBlk  is SS_NULL when this structure
...
#define ssGetOutputPortOkToMerge(S, port) \
    (SS_STATIC_CAST(ssOkToMergeFlag, (S)->portInfo.outputs[(port)].attributes.okToMerge))
...
#define ssGetSimStateCompliance(S) \
    (SS_STATIC_CAST(ssSimStateCompliance, (S)->sizes.flags.simStateCompliance))

#define ssGetOperatingPointCompliance(S) \
    (SS_STATIC_CAST(ssOperatingPointCompliance, (S)->sizes.flags.simStateCompliance))
...
#define ssSetJacobianType(S, type)            _ssSetJacobianTypeAndMsg(S, type, SS_NULL)

#define ssCallDefaultJacobianMethod(S)                                                  \
    {                                                                                   \
        _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_CALL_DEFAULT_JACOBIAN, 0, SS_NULL) \
            _ssSafelyCallGenericFcnEnd;                                                 \
    }
...
#define ssConfigDefaultJacobian(S)                                                        \
    {                                                                                     \
        ...
        _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_CONFIG_DEFAULT_JACOBIAN, 0, SS_NULL) \
            _ssSafelyCallGenericFcnEnd;                                                   \
    }
...
#define ssSetSupportRunTimeModelAPI(S, arg)                                                       \
    {                                                                                             \
        _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_SET_SUPPORT_RUNTIME_MODEL_API, arg, SS_NULL) \
            _ssSafelyCallGenericFcnEnd;                                                           \
    }
...
#define ssGetConstraints(S)       SS_NULL                   /* silently return invalid value */
#endif
 ...
 * @return An error character vector on failure, and SS_NULL if successful.
 */
#if SS_SL_INTERNAL
#define ssCallExternalModeFcn(S, meth)                          \
    ((S)->states.modelMethods2->extModeLogFcn != SS_NULL)       \
...
#define ssCheckDWorkRange(S, dworkIdx)                                                     \
    {                                                                                      \
        _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_CHECK_DWORK_RANGE, (dworkIdx), SS_NULL) \
            _ssSafelyCallGenericFcnEnd;                                                    \
    }
...
*/
#define _ssSetOwnerEbd(S, ebd) (S)->work.localMdlInfo->ownerEbd = (SS_STATIC_CAST(void*, ebd))
...
#define _ssGetGlobalTimerIndex(S, localIndex)                                                     \
    ((S)->work.localMdlInfo != SS_NULL ? (S)->work.localMdlInfo->globalTimerIndices[(localIndex)] \
                                       : (localIndex)) /*   (uint_T)    */
#if !SS_SFCN
...
#define ssSetDataAlignment(S, num)                                               \
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_SET_DATA_ALIGNMENT, num, SS_NULL) \
        _ssSafelyCallGenericFcnEnd
...
#define _ssSetSFcnExportsFunctionCalls(S)                                                       \
    _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_SET_EXPORTS_FUNCTION_CALLS, 0, (void*)SS_NULL) \
        _ssSafelyCallGenericFcnEnd

#define ssSetAcceptsFcnCallInputs(S)                                                            \
    _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_SET_ACCEPTS_FCNCALL_INPUTS, 0, (void*)SS_NULL) \
        _ssSafelyCallGenericFcnEnd
...
#define ssInportIsLatched(S, pIdx)                                                    \
    _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_SET_INPORT_LATCHED, (pIdx), SS_NULL) \
        _ssSafelyCallGenericFcnEnd
...
#define ssStrictBooleanCheckEnabled(S)                                                       \
    (((S)->states.modelMethods2->strictBooleanCheckEnabledFcn != SS_NULL)                    \
...
#define ssCallConvertBetweenForSrcId(S, dstId, srcId, numEls, u, options, y)                \
    (ssGetConvertBetweenFcn((S), (srcId)) != SS_NULL                                        \
...
#define ssCallConvertBetweenForDstId(S, dstId, srcId, numEls, u, options, y)                \
    (ssGetConvertBetweenFcn((S), (dstId)) != SS_NULL                                        \
...
#define ssCallConstruct(S, id, u)                                                     \
    (ssGetConstructFcn((S), (id)) != SS_NULL                                          \
...
#define ssCallDeepCopy(S, id, y, u)                                                          \
    (ssGetDeepCopyFcn((S), (srcId)) != SS_NULL                                               \
...
#define ssCallIsPositive(S, id, numEls, u, options, y)                                           \
    (ssGetIsPositiveFcn((S), (id)) != SS_NULL                                                    \
...
#define ssCallIsNegative(S, id, numEls, u, options, y)                                           \
    (ssGetIsNegativeFcn((S), (id)) != SS_NULL                                                    \
...
#define ssCallGreaterThan(S, id, numEls, u1, u2, options, y)                                       \
    (ssGetGreaterThanFcn((S), (id)) != SS_NULL                                                     \
...
#define ssCallGreaterEqual(S, id, numEls, u1, u2, options, y)                                 \
    (ssGetGreaterEqualFcn((S), (id)) != SS_NULL                                               \
...
#define ssSupportVarTsInMdlRef(S, flag)                                                        \
    {                                                                                          \
        if (ssGetOwnerBlock(S) != SS_NULL) {                                                   \
            boolean_T val = flag;                                                              \
            _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_SET_VARTS_MDLREF_SUPPORT, val, SS_NULL) \
                _ssSafelyCallGenericFcnEnd;                                                    \
        }                                                                                      \
    }
#else
...
#define ssSetDisallowContinuous(S, flag)                                               \
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_SET_DISALLOW_CONTINUOUS, flag, SS_NULL) \
        _ssSafelyCallGenericFcnEnd
...
#define ssGetSfcnHasMdlInputWidthFcn(S)                                                       \
    ((ssGetSFcnBitness(S) == SS_32BIT)                                                        \
         ? ((S)->modelMethods.sFcn.mdlSetInputPortDimensions.mdlSetInputPortWidth != SS_NULL) \
         : ((S)->blkInfo.blkInfo2->mdlInfoSLSize->mdlSetInputPortDimensions                   \
                .mdlSetInputPortWidth != SS_NULL))
...
#define ssGetmdlSetOutputPortWidth(S)                                          \
    ((ssGetSfcnHasMdlDimensionsFcn(S)) ? SS_NULL                               \
...
#define ssGetSfcnHasMdlOutputWidthFcn(S)                                                        \
    ((ssGetSFcnBitness(S) == SS_32BIT)                                                          \
         ? ((S)->modelMethods.sFcn.mdlSetOutputPortDimensions.mdlSetOutputPortWidth != SS_NULL) \
         : ((S)->blkInfo.blkInfo2->mdlInfoSLSize->mdlSetOutputPortDimensions                    \
                .mdlSetOutputPortWidth != SS_NULL))
...
#define ssGetSfcnHasMdlInputDimensionsFcn(S)                                                       \
    ((ssGetSFcnBitness(S) == SS_32BIT)                                                             \
         ? ((S)->modelMethods.sFcn.mdlSetInputPortDimensions.mdlSetInputPortDims != SS_NULL)       \
         : ((S)->blkInfo.blkInfo2->mdlInfoSLSize->mdlSetInputPortDimensions.mdlSetInputPortDims != \
            SS_NULL))
...
#define ssGetSfcnHasMdlOutputDimensionsFcn(S)                                                  \
    ((ssGetSFcnBitness(S) == SS_32BIT)                                                         \
         ? ((S)->modelMethods.sFcn.mdlSetOutputPortDimensions.mdlSetOutputPortDims != SS_NULL) \
         : ((S)->blkInfo.blkInfo2->mdlInfoSLSize->mdlSetOutputPortDimensions                   \
                .mdlSetOutputPortDims != SS_NULL))
...
/*
 * used internally to return a function that provides the propagation rules for unified
 * propagation
 *
 */
#define _ssSetMdlUnifiedTypePropRules(S, n)                               \
    ((S)->states.modelMethods2)->modelMethods4->mdlUnifiedTypePropRules = \
        (mdlUnifiedTypePropRulesFcn)(n)
#define _ssRunMdlUnifiedTypePropRules(S, n) \
    (*((S)->states.modelMethods2)->modelMethods4->mdlUnifiedTypePropRules)((S), (n))
...
/*-- AbsTol == 'auto' -- */
#define ssGetModelAbsTolIsAuto(S) ((S)->root->mdlInfo->mdlFlags.isModelAbsTolAuto)
#if !SS_SFCN
#define ssSetModelAbsTolIsAuto(S, val) (S)->root->mdlInfo->mdlFlags.isModelAbsTolAuto = val
#else
#define ssSetModelAbsTolIsAuto(s) ssSetModelAbsTolIsAuto_cannot_be_used_in_SFunctions
#endif

/*-- AutoScaleAbsTol == 'on' -- */
#define ssGetModelAbsTolIsScaled(S) ((S)->root->mdlInfo->mdlFlags.isModelAbsTolScaled)
#if !SS_SFCN
#define ssSetModelAbsTolIsScaled(S, val) (S)->root->mdlInfo->mdlFlags.isModelAbsTolScaled = val
#else
#define ssSetModelAbsTolIsScaled(s) ssSetModelAbsTolIsScaled_cannot_be_used_in_SFunctions
#endif
 ...
 * The ((void)0) is there so one use a semicolon and not trigger clang -Wextra-semi-stmt:
 *     ssGetSFcnRepresentation(sfcnS, &sfcnRepresentation);
 */
...
#define ssLoggerCreateDatasetDescription(S, datasetName, ppSetDesc) \
    _ssLoggerCreateDatasetDescriptWithMMI(S, SS_NULL, 0, SS_NULL, datasetName, ppSetDesc)

#define ssLoggerGetSignalLoggingDatasetDescription(S, ppSetDesc) \
    _ssLoggerCreateDatasetDescriptWithMMI(S, SS_NULL, 0, SS_NULL, SS_NULL, ppSetDesc)
...
#define ssLoggerCreateMdlRefDatasetDescription(S, nRefModelPath, refPath, datasetName, ppSetDesc) \
    _ssLoggerCreateDatasetDescriptWithMMI(S, SS_NULL, nRefModelPath, refPath, datasetName,        \
                                          ppSetDesc)

#define ssLoggerGetMdlRefSignalLoggingDatasetDescription(S, nRefModelPath, refPath, ppSetDesc) \
    _ssLoggerCreateDatasetDescriptWithMMI(S, SS_NULL, nRefModelPath, refPath, SS_NULL, ppSetDesc)

#define ssObserverGetMdlRefObserverDatasetDescription(S, nRefModelPath, refPath, ppSetDesc) \
    _ssCreateObserverDatasetDescriptWithMMI(S, SS_NULL, nRefModelPath, refPath, ppSetDesc)
...
#define ssLoggerCreateElementFromDescription(S, ppSetDesc, elementPtrArray)                  \
    {                                                                                        \
        ...
        info.busName = SS_NULL;                                                              \
        info.sfOffsets = SS_NULL;                                                            \
...
#define ssGetDynamicStringDefaultBufferSize(S)                                             \
    ((size_t)_ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_GET_STRING_DEFAULT_BUFFER_SIZE, 0, \
                                             SS_NULL) _ssSafelyCallGenericFcnEnd)
#else
#define ssGetDynamicStringDefaultBufferSize(S) \
...
#define ssGetTargetLangStandard(S)                                                           \
    (_ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_GET_STRING_TARGET_LANG_STANDARD, 0, SS_NULL) \
         _ssSafelyCallGenericFcnEnd)
#else
...
#define ssGetUseCppClass(S)                                                                 \
    ((bool)_ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_GET_STRING_USE_CPP_CLASS, 0, SS_NULL) \
         _ssSafelyCallGenericFcnEnd)
#else
...
#define ssIsPointerDataType(S, dataTypeId)                                                       \
    ((bool)_ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_IS_POINTER_DATA_TYPE, dataTypeId, SS_NULL) \
         _ssSafelyCallGenericFcnEnd)
...
#define ssGetPointerContainedDataType(S, dataTypeId)                                      \
    ((DTypeId)_ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_GET_POINTER_CONTAINED_DATA_TYPE, \
                                              dataTypeId, SS_NULL) _ssSafelyCallGenericFcnEnd)

#define ssGetPointerContainedDataComplexity(S, dataTypeId)                     \
    ((ssComplexity)_ssSafelyCallGenericFcnStart(S)(                            \
        S, GEN_FCN_GET_POINTER_CONTAINED_DATA_COMPLEXITY, dataTypeId, SS_NULL) \
         _ssSafelyCallGenericFcnEnd)
...
#define ssGetDynamicArrayContainedDataComplexity(S, dataTypeId)                      \
    ((ssComplexity)_ssSafelyCallGenericFcnStart(S)(                                  \
        S, GEN_FCN_GET_DYNAMIC_ARRAY_CONTAINED_DATA_COMPLEXITY, dataTypeId, SS_NULL) \
         _ssSafelyCallGenericFcnEnd)
#else
#define ssGetDynamicArrayContainedDataComplexity(S, dataTypeId) \
...
#define ssGetDynamicArrayContainedDataDimensions(S, dtId, dimsArg)                             \
    {                                                                                          \
        ...
        slDynamicArrayRec.data = SS_NULL;                                                      \
        slDynamicArrayRec.constData = SS_NULL;                                                 \
        slDynamicArrayRec.retData = SS_NULL;                                                   \
        slDynamicArrayRec.dims = (dimsArg);                                                    \
        slDynamicArrayRec.constDims = SS_NULL;                                                 \
...
#define ssSetDynamicArrayContainedDataCurrentDimensions(S, dtId, dataArg, numDimsArg, dimsArg)    \
    {                                                                                             \
        ...
        slDynamicArrayRec.constData = SS_NULL;                                                    \
        slDynamicArrayRec.retData = SS_NULL;                                                      \
        slDynamicArrayRec.dims = SS_NULL;                                                         \
...
#define ssGetDynamicArrayDWorkContainedDataWidth(S, idx)                                           \
    ((int)_ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_GET_DYNAMIC_ARRAY_DWORK_CONTAINED_DATA_WIDTH, \
                                          idx, SS_NULL) _ssSafelyCallGenericFcnEnd)
#else
...
#define ssGetDynamicArrayDWorkContainedDataComplexSignal(S, idx)                    \
    ((ssComplexity)_ssSafelyCallGenericFcnStart(S)(                                 \
        S, GEN_FCN_GET_DYNAMIC_ARRAY_DWORK_CONTAINED_DATA_COMPLEXITY, idx, SS_NULL) \
         _ssSafelyCallGenericFcnEnd)
#else
 ...
 * LocalWords:  tid's zc intg conds nd resolveCBK vals sti iwork rwork pwork stringtype Wunused
 * LocalWords:  nzMax compat SG et AslErrMsg RWork IWork PWork SFunctions untest Wzero Unaddressable
 * LocalWords:  versioning NonsampledZCs SlvrJacobian FCSSCtrl fixedpoint CSignal Wextra stmt
