...
struct _RTWExtModeInfo_tag {
    ...
    int32_T tFinalTicks; /* Holds the number of base rate ticks representing the
                          * final time (final time in seconds divided by base
                          * rate step size). Used by PurelyIntegerCode and
                          * ExtModeXCPSimulationTimeInTicks
                          */
};
...
#define rteiSetTFinalTicks(E, val) ((E)->tFinalTicks = (val))
